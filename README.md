...
## Login Startup
I created database.js and dbConfig.json. The js file contains functions necessary to complete my endpoints and reach the database within MongoDB, and said functions are utilized by index.js upon importing the file. The json file contains cluster data necessary to access the database.